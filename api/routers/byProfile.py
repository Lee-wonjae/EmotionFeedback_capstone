...
async def RSbyProfile(data:profileData):
    ...
    ("system", "Based on the detailed profile including interest, recommend direct and not boring subjects for discussion. Generate a COMMA-SEPARATED LIST of 5 topics. Like this: Topic 1, Topic 2, Topic 3, Topic 4, Topic 5"),
